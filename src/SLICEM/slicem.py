...
def main():
    ...
    parser.add_argument('-i', '--input', action='store', dest='mrc_input', required=False, default='../code_data_results/data/real_dataset/mixture_2D.mrcs',
                        help='path to mrcs file of 2D class averages')
    
    parser.add_argument('-o', '--outpath', action='store', dest='outpath', required=False, default = '../code_data_results/data/real_dataset/',
                        help='path for output files')
    
    parser.add_argument('-m', '--metric', action='store', dest='metric', required=False, 
                        default='L1', choices=['Euclidean', 'L1', 'cosine', 'EMD', 'correlate'],
