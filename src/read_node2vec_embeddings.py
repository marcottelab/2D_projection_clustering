...
def slicem_graph_embeddings(node_embedding_method='metapath2vec', implementation = 'stellar',graph = 'top5_unnorm'):
    '''
    ...
    if implementation == 'original':
        ...
        with open('../data/real_dataset/top5_graph_stellar_' + node_embedding_method + '.npy', 'rb') as f:
            node_embeddings = np.load(f)
            
        with open('../data/real_dataset/top5_graph_stellar_' + node_embedding_method + '_node_ids.list', 'rb') as f:
            node_ids = pkl_load(f)
