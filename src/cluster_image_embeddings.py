...
def get_image_embedding(data,embedding_model = 'resnet-18',combine_graph_flag=0,graph_embedding_method='',dataset='real',graph_name='slicem_edge_list',graph_type='directed',node_attribute_method='siamese'):  
    ...
    elif embedding_model in ['siamese','siamese_noisy','siamese_more_projs_all','siamese_more_projs_noisy','siamese_real']:
        if embedding_model in ['siamese_more_projs_all','siamese_more_projs_noisy']:
...
def main():
    ...
    parser.add_argument("--node_attribute_methods", nargs='+', default=[''], help="Image embeddings used as node attributes in the graph embeddings")
    ...
    parser.add_argument("--embedding_methods", nargs='+', default=['siamese_real'], help="Image embeddings - either pure or pure slicem graph")
