...
def main():
    ...
    parser.add_argument("--embedding_methods", nargs='+', default=['siamese_real'], help="Image embeddings - either pure or pure slicem graph, ex: 'attri2vec','gcn','cluster_gcn','gat','APPNP','graphSage'")
