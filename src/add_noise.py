...
plt.gray()
plt.imsave('../data/synthetic_dataset/img1_original.png',data[0])

plt.imsave('../data/synthetic_dataset/img2_original.png',data[1])
...
plt.imsave('../data/synthetic_dataset/img1_noisy.png',data_noisy_nonneg[0])

plt.imsave('../data/synthetic_dataset/img2_noisy.png',data_noisy_nonneg[1])

data_noisy_arr = np.array(data_noisy_nonneg, dtype='<f4')

import mrcfile
with mrcfile.new('../data/synthetic_dataset/synthetic_noisy.mrcs',overwrite=True) as mrc:
