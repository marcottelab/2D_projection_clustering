...
#anchor= tf.data.Dataset.from_tensors(converted_data[0])
#positive = tf.data.Dataset.from_tensors(converted_data[1])
#negative =  tf.data.Dataset.from_tensors(converted_data[100])
